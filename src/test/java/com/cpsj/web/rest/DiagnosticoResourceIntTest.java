...
import com.cpsj.repository.DiagnosticoRepository;
import com.cpsj.service.DiagnosticoService;
import com.cpsj.service.dto.DiagnosticoDTO;
import com.cpsj.service.mapper.DiagnosticoMapper;
...
public class DiagnosticoResourceIntTest {
    ...
    private static final String DEFAULT_NOMBRE_DIAGNOSTICO = "AAAAAAAAAA";
    private static final String UPDATED_NOMBRE_DIAGNOSTICO = "BBBBBBBBBB";
    ...
    public static Diagnostico createEntity(EntityManager em) {
        Diagnostico diagnostico = new Diagnostico()
            ...
            .nombreDiagnostico(DEFAULT_NOMBRE_DIAGNOSTICO)
    ...
    public void createDiagnostico() throws Exception {
        ...
        assertThat(testDiagnostico.getIdDiagnostico()).isEqualTo(DEFAULT_ID_DIAGNOSTICO);
        assertThat(testDiagnostico.getCodigoDiagnostico()).isEqualTo(DEFAULT_CODIGO_DIAGNOSTICO);
        assertThat(testDiagnostico.getNombreDiagnostico()).isEqualTo(DEFAULT_NOMBRE_DIAGNOSTICO);
    ...
    public void getAllDiagnosticos() throws Exception {
        ...
        restDiagnosticoMockMvc.perform(get("/api/diagnosticos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nombreDiagnostico").value(hasItem(DEFAULT_NOMBRE_DIAGNOSTICO.toString())))
    ...
    public void getDiagnostico() throws Exception {
        ...
        restDiagnosticoMockMvc.perform(get("/api/diagnosticos/{id}", diagnostico.getId()))
            ...
            .andExpect(jsonPath("$.nombreDiagnostico").value(DEFAULT_NOMBRE_DIAGNOSTICO.toString()))
    ...
    public void updateDiagnostico() throws Exception {
        ...
        updatedDiagnostico
            ...
            .nombreDiagnostico(UPDATED_NOMBRE_DIAGNOSTICO)
        ...
        Diagnostico testDiagnostico = diagnosticoList.get(diagnosticoList.size() - 1);
        assertThat(testDiagnostico.getIdDiagnostico()).isEqualTo(UPDATED_ID_DIAGNOSTICO);
        assertThat(testDiagnostico.getCodigoDiagnostico()).isEqualTo(UPDATED_CODIGO_DIAGNOSTICO);
        assertThat(testDiagnostico.getNombreDiagnostico()).isEqualTo(UPDATED_NOMBRE_DIAGNOSTICO);
