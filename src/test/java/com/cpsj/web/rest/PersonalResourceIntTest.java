...
import com.cpsj.repository.PersonalRepository;
import com.cpsj.service.PersonalService;
import com.cpsj.service.dto.PersonalDTO;
import com.cpsj.service.mapper.PersonalMapper;
...
public class PersonalResourceIntTest {
    ...
    private static final String DEFAULT_CARGO_PERSONAL = "AAAAAAAAAA";
    private static final String UPDATED_CARGO_PERSONAL = "BBBBBBBBBB";
    ...
    public static Personal createEntity(EntityManager em) {
        Personal personal = new Personal()
            ...
            .cargoPersonal(DEFAULT_CARGO_PERSONAL);
        return personal;
    }
    ...
    public void createPersonal() throws Exception {
        ...
        assertThat(testPersonal.getCargoPersonal()).isEqualTo(DEFAULT_CARGO_PERSONAL);
    }
    ...
    public void getAllPersonals() throws Exception {
        ...
        restPersonalMockMvc.perform(get("/api/personals?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cargoPersonal").value(hasItem(DEFAULT_CARGO_PERSONAL.toString())));
    }
    ...
    public void getPersonal() throws Exception {
        ...
        restPersonalMockMvc.perform(get("/api/personals/{id}", personal.getId()))
            ...
            .andExpect(jsonPath("$.cargoPersonal").value(DEFAULT_CARGO_PERSONAL.toString()));
    }
    @Test
    @Transactional
    ...
    public void updatePersonal() throws Exception {
        ...
        updatedPersonal
            ...
            .cargoPersonal(UPDATED_CARGO_PERSONAL);
        ...
        assertThat(testPersonal.getCargoPersonal()).isEqualTo(UPDATED_CARGO_PERSONAL);
    }
