    ...
    describe('Sucursal Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sucursals';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Sucursal', () => {
                service.create(new Sucursal(null)).subscribe(received => {
            ...
            it('should update a Sucursal', () => {
                service.update(new Sucursal(123)).subscribe(received => {
