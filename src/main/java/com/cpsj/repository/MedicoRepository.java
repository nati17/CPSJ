...
public interface MedicoRepository extends JpaRepository<Medico, Long> {
    ...
    @Query(value = "select distinct medico from Medico medico left join fetch medico.obrasocials left join fetch medico.especialidads",
    ...
    @Query("select medico from Medico medico left join fetch medico.obrasocials left join fetch medico.especialidads where medico.id =:id")
